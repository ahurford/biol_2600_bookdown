...
**Importing the CSV**
Now that we have a clean work space, import the data into R. **You <u>cannot</u> directly copy the following line of code for it to work. The location of the data on my computer is different from the location on your computer.**
...
### Method 1: Producing four separate plots
...
```{r, figure.hight=10, fig.width=10}
...
### Method 2: Producing two separate plots on the same y-axis
...
### Method 3: Producing two separate double y-axis plots
...
### Method 4: Produce two double y-axis plots atop of each other
